...
# follows the instructions one character at a time. An opening parenthesis,
# (, means he should go up one floor, and a closing parenthesis, ), means
# he should go down one floor. The apartment building is very tall, and the
# basement is very deep; he will never find the top or bottom floors.
#
# For example:
#
